...
/**
 * Draw history table, shared by every game section.
 *
 * `game` selects the per-game bits (currently just how item icons are looked
 * up); everything else is identical across the five games, which is why this
 * used to exist as five near-identical copies.
 */
const ItemTable = ({ game, items, itemIcons }) => {
