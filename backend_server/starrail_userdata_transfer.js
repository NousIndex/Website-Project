...
const range = 'Transfer2!A1:E';
const userID = '801903001';
let dataArray = [];
  ...
  try {
    ...
    if (values.length) {
      ...
      values.forEach((row) => {
        ...
        const dataObject = {
          StarRail_UID: userID, // Assuming the first column contains Genshin_UID
      ...
      //   const result = await prisma.StarRail_Draw.createMany({
      //     data: dataArray,
      //   });
